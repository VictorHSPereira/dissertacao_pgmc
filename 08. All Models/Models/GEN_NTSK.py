...
class GEN_NTSK:
    def __init__(self, n_clusters = 5, lambda1 = 1, RLS_option = 1, omega = 1000, num_generations = 10, num_parents_mating = 10, sol_per_pop = 20, error_metric = "RMSE", print_information=False):
        # Parameters
    ...
    def fit(self, X, y):
        ...
        self.model = NTSK(n_clusters = self.n_clusters, lambda1 = self.lambda1, RLS_option = self.RLS_option)
        # Train the model
        self.model.fit(X, y)
